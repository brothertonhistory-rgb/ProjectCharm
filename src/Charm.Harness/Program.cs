...
internal static partial class Program
{
    private static int Main(string[] args)
    {
        ...
        // ★ S108 — emit the input tools/nonconference_dates_oracle.py reads, so the S106
        //   dating golden can be regenerated by anyone at any time. S106 built this file by
        //   hand and the recipe left with the session.
        if (args.Length > 0 && args[0] == "dates-input") { return RunDatesInput(configPath, args); }
