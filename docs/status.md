...
| B — Halfcourt initiation | Pressure + steals-vs-handling matchup (P13); **unforced-turnover handling curve on the neutral base (S56/P62)** |
...
| F — Player action | Pressure + matchup (P12); **unforced-turnover handling curve on the neutral base (S56/P62)** |
...
- **Attribute-meaning layer — the `sweep` bench is BUILT (S45), its picker bug FIXED (S46), and its
  ...
  **height-over-defender make term the item that most gates the height→skill lean sizing**. **That term
  ...
  candidate wiring gap), (5) the remaining S50 physical questions (**wingspan→steals unwired** — the
  cleanest genuine hole left; block channel light; Weight cosmetic). The pressure-dialed channels (BallHandling, Steals turnover-forcing) stay
