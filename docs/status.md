...
| G — Shot location | Matchup bend on residualized gaps (P9 + S36 Route B), coaching nudge (P30), usage diet shift (P17), attention amplifier (P28), **matchup displacement** (S36), **fast-break diet bent per shooter + PaceBias tilt** (S38), **PostMoves interior diet tilt + pressure resistance** (S57/P63) |
...
- **Attribute-meaning layer — the `sweep` bench is BUILT (S45), its picker bug FIXED (S46), and its
  ...
  **height-over-defender make term the item that most gates the height→skill lean sizing**. **That term
  ...
  (4) the S54 defensive findings (perimeter-defense point-neutrality; Discipline near-inert — a
  candidate wiring gap), (5) ~~the remaining S50 physical questions (**wingspan→steals unwired**)~~ —
