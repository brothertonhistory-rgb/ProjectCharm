...
- **Attribute-meaning layer — the `sweep` bench is BUILT (S45), its picker bug FIXED (S46), and its
  ...
  **F. Interior offense is MEASURED (S51)** — two walks (PostMoves, Screening) + a seven-row
  ...
  The remaining families, each following the same template: **G. Defense** (PerimeterDefense,
  PostDefense, RimProtection, Steals, HelpDefense, OffBallDefense) · **H. Cognition** (BasketballIQ,
