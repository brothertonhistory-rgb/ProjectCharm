...
- **Era profile** — five weight-space multipliers applied immediately after peakedness (Rim 1.00 / Short 0.66 / Mid 0.50 / Long 0.70 / Three 2.10), encoding the modern shot-selection *culture* (threes up, mid-range way down, floaters and long twos trimmed, rim untouched) cleanly separated from individual *capability*. An earlier-era league is these five numbers and nothing else.
